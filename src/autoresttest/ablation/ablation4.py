...
def init_graph_ablation_4(spec_name: str, spec_path, embedding_model, config: Config | None = None) -> OperationGraph:
...
def generate_graph_ablation_4(spec_dir, spec_name, embedding_model, config: Config | None = None):
    print("Generating graph!")
    spec_path = f"{spec_dir}{spec_name}.yaml"
    operation_graph = init_graph_ablation_4(spec_name, spec_path, embedding_model, config=config)
...
def execute_ablation_4(spec_dir, spec_name, duration, config: Config | None = None):
    """
    ...
    operation_graph = generate_graph_ablation_4(spec_dir, spec_name, embedding_model, config=config)
